  ...
  return (
    <div className="space-y-6">
      ...
      <InfoBox
        ...
        useCases={t('ascii.useCases', { returnObjects: true }) as string[]}
        examples={[
          { label: "'A'", value: 'ASCII 65 (bin: 01000001)' },
          { label: "'Hello'", value: '72 101 108 108 111' },
          { label: "'0'", value: 'ASCII 48' }
        ]}
      ...
      <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <div className="glass-card specular-highlight p-5">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="text-sm font-bold text-liquid-300 uppercase tracking-wider">{t('ascii.decimal')}</h4>
                  <button
              ...
              <div className="glass-card specular-highlight p-5">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="text-sm font-bold text-liquid-300 uppercase tracking-wider">{t('ascii.binary')}</h4>
                  <button
              ...
              <div className="glass-card specular-highlight p-5">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="text-sm font-bold text-liquid-300 uppercase tracking-wider">{t('ascii.hex')}</h4>
                  <button
        ...
        <div className="space-y-4">
          ...
          {asciiInput && (
            <div className="glass-card specular-highlight p-5">
              <div className="flex items-center justify-between mb-3">
                <h4 className="text-sm font-bold text-liquid-300 uppercase tracking-wider">{t('ascii.textResult')}</h4>
                <button
